...
INSERT INTO reviews (review_id, whisky_id, score, comment) VALUES (6, 4, 10, 'いつもの一本。スモーキーで甘い僕の親友。ロックが最高！');
INSERT INTO reviews (review_id, whisky_id, score, comment) VALUES (7, 5, 12, 'シェリーの風味にオークのバニラ、樽香が溶け合う心地よい一本。少々値が張る。');
